...
/*
Package app_php_golang_client_server is a generated twirp stub package.
...
func NewHaberdasherProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Haberdasher {
	...
	serviceURL += baseServicePath(clientOpts.PathPrefix(), "app_php_golang_client_server", "Haberdasher")
	urls := [1]string{
		serviceURL + "MakeHat",
	}
...
func (c *haberdasherProtobufClient) MakeHat(ctx context.Context, in *Size) (*Hat, error) {
	ctx = ctxsetters.WithPackageName(ctx, "app_php_golang_client_server")
...
const HaberdasherPathPrefix = "/twirp/app_php_golang_client_server.Haberdasher/"
...
func (s *haberdasherServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "app_php_golang_client_server.Haberdasher" {
...
func (s *haberdasherServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "app_php_golang_client_server", "Haberdasher")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
