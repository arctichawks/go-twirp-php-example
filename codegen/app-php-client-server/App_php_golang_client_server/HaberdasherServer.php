...
final class HaberdasherServer implements RequestHandlerInterface
{
     ...
     */
    public const PATH_PREFIX = '/twirp/app_php_golang_client_server.Haberdasher/';
    ...
    {
        return $this->prefix.'/app_php_golang_client_server.Haberdasher/';
    }
    ...
    public function handle(ServerRequestInterface $req): ResponseInterface
    {
        ...
        $ctx = Context::withPackageName($ctx, 'app_php_golang_client_server');
        ...
        if ($service != 'app_php_golang_client_server.Haberdasher') {
    ...
    private function handleMakeHatJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        try {
            ...
            $in = new \App_php_golang_client_server\Size();
