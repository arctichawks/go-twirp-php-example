...
abstract class HaberdasherAbstractClient
{
     ...
     * {@inheritdoc}
     */
    public function MakeHat(array $ctx, \App_php_golang_client_server\Size $in): \App_php_golang_client_server\Hat
    {
        ...
        $out = new \App_php_golang_client_server\Hat();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/app_php_golang_client_server.Haberdasher/MakeHat';
        } else {
            $url = $url.'/'.$this->prefix.'/app_php_golang_client_server.Haberdasher/MakeHat';
        }
    ...
    protected function newRequest(array $ctx, string $url, string $reqBody, string $contentType): RequestInterface
    {
        ...
        return $req
            ...
            ->withHeader('TwirPHP-Version', '0.10.0')
        ;
    }
